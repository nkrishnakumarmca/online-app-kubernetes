package com.kk.userservice.profile.commander.integrationtest;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.kk.userservice.UserServiceApplication;
import com.kk.userservice.profile.dto.AddressDto;
import com.kk.userservice.profile.dto.CartProductDto;
import com.kk.userservice.profile.dto.CustomerDto;
import com.kk.userservice.profile.dto.NewCustomerDto;
import com.kk.userservice.profile.dto.OrderDto;
...
public class CustomerControllerITTests {
    ...
    public void setUp() {
        ...
        com.kk.userservice.profile.model.Order order = new com.kk.userservice.profile.model.Order("o1", "c1", products, LocalDate.now(), address, address, "creditcard", 100, "completed");
